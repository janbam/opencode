/**
 * NO-BUN: Stream utilities compatibility layer
 *
 * Replaces Bun's readableStreamToText with Node.js equivalents.
 *
 * Usage:
 *   // Instead of: import { readableStreamToText } from "bun"
 *   import { readableStreamToText } from './compat/stream'
 */
 ...
 *
 * Works with both Node.js Readable streams and Web ReadableStream.
 *
 * @example
 * const proc = spawn(['git', 'status'], { stdout: 'pipe' })
